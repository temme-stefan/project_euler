...
console.log("Coded triangle numbers");
console.log(`The nth term of the sequence of triangle numbers is given by, tn = ½n(n+1); so the first ten triangle numbers are:
...
console.log("https://projecteuler.net/problem=42");
